...
import OverallControlIcon from "../../Images/icons/commision.svg";
...
const AboutUs = () => {
  ...
  return (
    <div className=" mt-10 w-10/12 max-md:w-[90%] mx-auto flex">
      <div className="w-full flex gap-20 mt-10 max-lg:flex-col max-md:mt-2">
        <div className="bg-[#F7F7FD] w-[35%] pt-8 rounded-lg relative h-[590px] max-md:h-[680px] max-lg:w-full">
          <div className="px-9 flex flex-col gap-5 max-md:px-7">
            ...
            Finding the perfect home has never been easier. With our seamless platform, you can explore a wide range of properties, from cozy apartments to luxurious villas, all tailored to your needs. Whether you're looking to rent, buy, or invest, we provide the tools to help you make informed decisions—without the hassle. Start your journey today and discover a smarter, faster way to find your dream home.
            </p>
            <div>
          ...
          {/* <div className="pl-12 mt-3"> */}
            <img src={House} className='' alt="House Diagram" />
          </div>
        </div>

        <div className="flex w-[60%] flex-wrap gap-8 text-navy-blue max-lg:w-full max-md:flex-col max-md:gap-10">
          {AboutUsDetails.map((item, index) => (
            <div key={index} className="basis-[330px] max-lg:basis-[45%] max-md:basis-0  max-md:border-b-2 max-md:border-gray-200 max-md:pb-7" >
              <div className=" gap-4">
                <div className="flex flex-col gap-5">
                  <div className="flex flex-col gap-5 max-md:flex-row max-md:gap-2 max-md:items-center">
                      <div className=''>
